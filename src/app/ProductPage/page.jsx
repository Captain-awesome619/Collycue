...
const Page = () => {
  ...
  const getData = async () => {
    ...
    fetch(
      `https://www.ailabapi.com/api/common/query-async-task-result?task_id=${value22}`,
      requestOptions
    )
      .then((response) => response.text())
      .then((message) => {
  ...
  function handleClick4() {
    setupload(true), setoptions(true);
  }
  function handleClick5() {
    setupload(false), setoptions(false);
  }
            ...
            <div className=' flex items-center justify-center'>
              <div
                ...
                <div
                  ...
                  <div
                    className={`lg:aspect-[50/80] aspect-[70/80] lg:w-[500px] lg:h-[517px]   flex `}
                    style={{
                      backgroundImage: `url("${display.second}")`,
